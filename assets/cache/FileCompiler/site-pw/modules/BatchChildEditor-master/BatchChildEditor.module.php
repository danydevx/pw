...
class BatchChildEditor extends \ProcessWire\WireData implements \ProcessWire\Module, \ProcessWire\ConfigurableModule {
 ...
 require_once(\ProcessWire\wire('files')->compile(\ProcessWire\wire("config")->paths->root . 'site-pw/modules/BatchChildEditor-master' . '/parsecsv-for-php/parsecsv.lib.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));
    ...
    public function getModuleConfigInputfields(array $data) {
        ...
        $fieldEnabledTemplates->label = \ProcessWire\__('Enabled templates', \ProcessWire\wire("config")->paths->root . 'site-pw/modules/BatchChildEditor-master/BatchChildEditor.module.php');
        $fieldEnabledTemplates->columnWidth = 33;
        $fieldEnabledTemplates->description = \ProcessWire\__("The batch editing option will only be available for the selected templates.\nLeave blank to allow all templates.", \ProcessWire\wire("config")->paths->root . 'site-pw/modules/BatchChildEditor-master/BatchChildEditor.module.php');
        ...
        $fieldEnabledPages->label = \ProcessWire\__('Enabled pages', \ProcessWire\wire("config")->paths->root . 'site-pw/modules/BatchChildEditor-master/BatchChildEditor.module.php');
        $fieldEnabledPages->columnWidth = 34;
        $fieldEnabledPages->description = \ProcessWire\__("The batch editing option will only be available for the selected pages.\nLeave blank to allow all pages.", \ProcessWire\wire("config")->paths->root . 'site-pw/modules/BatchChildEditor-master/BatchChildEditor.module.php');
