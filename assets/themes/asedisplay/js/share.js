    ...
    $('.share-button').click(function () {
        ...
        switch (platform) {
            ...
            case 'whatsapp':
                ...
                break;
            case 'telegram':
                var telegramText = 'Check out this awesome website!';
                window.open('https://t.me/share/url?url=' + encodeURIComponent(currentUrl) + '&text=' + encodeURIComponent(telegramText));
                break;
            default:
                break;
        }
