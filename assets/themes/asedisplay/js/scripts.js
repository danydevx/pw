$(document).ready(function () {
  ...
  initSwiper(".swiper.testimonial-carousel", {
    slidesPerView: 1,
    spaceBetween: 0,
    loop: true,
    grabCursor: true,
  ...
  initSwiper(".swiper.card-carousel", {
    // Default parameters
    slidesPerView: 1,
    spaceBetween: 10,
    grabCursor: true,
  ...
  initSwiper(".swiper.gallery-history", {
    // Default parameters
    slidesPerView: 1,
    spaceBetween: 10,
    grabCursor: true,
  ...
  initSwiper(".swiper.career-carousel", {
    // Default parameters
    slidesPerView: 1,
    spaceBetween: 10,
    grabCursor: true,
  ...
  initSwiper(".swiper.testimonial-slider", {
    slidesPerView: 3,
    spaceBetween: 20,
    loop: true,
    grabCursor: true,
  ...
  initSwiper(".swiper.project-carousel", {
    slidesPerView: 2,
    spaceBetween: 10,
    loop: true,
    grabCursor: true,
  ...
  initSwiper(".swiper.project-carousel-3", {
    slidesPerView: 3,
    spaceBetween: 10,
    loop: true,
    grabCursor: true,
  ...
  var themeStorageKey = "ase-theme-scheme";
  ...
  function applyTheme(theme) {
    ...
    if (themeToggleBtn) {
      ...
      themeToggleBtn.setAttribute("aria-label", isLight ? "Activar tema oscuro" : "Activar tema claro");
      themeToggleBtn.setAttribute("title", isLight ? "Tema claro activo" : "Tema oscuro activo");
    }
  }
