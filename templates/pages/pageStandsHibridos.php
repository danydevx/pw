...
$seo = buildSeoData($page, [
  'title' => $title,
  'description' => 'Stands hibridos que combinan modularidad y personalizacion para optimizar inversion y presencia.',
]);
$view  = VIEWS.  'pages/page-stands-hibridos.view.php';
