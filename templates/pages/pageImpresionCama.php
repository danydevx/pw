...
$seo = buildSeoData($page, [
  'title' => $title,
  'description' => 'Servicio especializado de impresion cama plana para piezas rigidas y aplicaciones de alto impacto visual.',
]);
$view  = VIEWS.  'pages/page-impresion-cama.view.php';
