...
require_once __DIR__ . '/blocks/RapidBlocks.php';
 ...
 * FieldtypeRapid
 *
 * Stores EditorJS block-editor content as JSON.
...
class FieldtypeRapid extends Fieldtype {
	...
	public static function getModuleInfo(): array {
		return [
			'title'    => 'Rapid',
			'version'  => 102,
			'summary'  => 'EditorJS block editor field for ProcessWire.',
			'icon'     => 'bolt',
	 ...
	 * so EditorJS always receives valid data on wakeup.
	 */
	...
	public function ___getConfigInputfields(Field $field): InputfieldWrapper {
		...
		// paragraph is EditorJS built-in default block — always available, not filterable
		...
		$afe->description = $this->_('Comma-separated. Leave empty to allow all. Example: pdf,doc,xlsx,zip');
