...
class ProcessRapid extends Process {
	...
	public function ___executeDashboard(): string {
		...
		$rapidUrl = $config->urls->get('FieldtypeRapid');
	...
	private function renderDashboard(array $d): string {
		...
		<div class="rapid-dashboard">
			...
			<div class="rapid-section">
				...
				<div class="rapid-bundle">
					...
					<span>Path: <b>Rapid/js/dist/editor.js</b></span>
				</div>
			</div>
		</div>
		HTML;
		...
		$rapidUrl = $d['rapidUrl'];
		$css = "<link rel='stylesheet' href='{$rapidUrl}js/editor.css'>";
		return $css . $out;
	}
	...
	public function ___executePreview(): string {
		...
		$assets  = "<link rel='stylesheet' href='{$rapidUrl}js/editor.css'>";
		$assets .= "<link rel='stylesheet' href='{$rapidUrl}js/vendor/swiper.min.css'>";
		$assets .= "<script src='{$rapidUrl}js/vendor/swiper.min.js'></script>";
